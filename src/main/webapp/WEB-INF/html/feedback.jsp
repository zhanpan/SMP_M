...
<!-- 投诉信息详情显示 -->
		...
		<div class="modal-dialog" role="document" style="width: 65%;">
			<div class="modal-content">
				...
				<div class="notice-halftitle"><h4><span id="FeedbackTitle"></span></h4></div> 
            ...
            success: function(data) {
                if (data.code == "200") {
                    ...
                    function(index, obj) {
                        ...
                        if (type == 3) {
                            htmlStr += '<td class="t_2_q"><div class="btn_gonggao">' + '<button onclick="deleteFeedBack(' + obj.id + ')" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-minus"></span> 删除</button></div></td>';
                        }
                        htmlStr += '</tr>';
                    });
