...
<body>
	...
	<div class="loginBox">
		<div class="logo">
			<img class="login" src="static/images/logo_yijia.png" />
		</div>
		<div class="loginMain">
			<div class="tabwrap">
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td><input type="button" class="loginbtn" value="登录"
							id="login" /> <input type="button" class="resetbtn" value="重置"
							id="reset" /></td>
					</tr>
					<tr>
	...
	<div class="footer">Copyright © 2018-2021 讯飞无限 All Rights
		Reserved.</div>
