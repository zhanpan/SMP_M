		...
		<div class="modal-dialog" role="document" style="width: 65%;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">修改信息<span>必须输入标题!</span><span>必须输入副标题!</span><span>必须输入公告内容!</span></h4>
				</div>
				<div class="modal-body-title">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<span style="font-size: 10px; color: red;">*(长度必须小于8)</span>
							<div style="width: 70%; ">
						...
						<div class="form-group">
							...
							<span style="font-size: 10px; color: red;">*(内容长度必须小于200)</span>
							<div style="width: 81%;">
		...
		<div class="modal-dialog" role="document" style="width: 65%;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">添加信息<span>必须输入标题!</span><span>必须输入副标题!</span><span>必须输入公告内容!</span>
					</h4>
				...
				<div class="modal-body-title">
					<form class="form-horizontal" role="form">
						<div class="form-group">
							...
							<span style="font-size: 10px; color: red;">*(长度必须小于8位)</span>
								<div style="width: 70%;">
						...
						<div class="form-group">
						<label for="create-describe" class="control-label">公告内容</label>
						<span style="font-size: 10px; color: red;">*(内容长度必须小于200位)</span>
						<div style="width: 81%;">
            ...
            success: function(data) {
                if (data.code == "200") {
                    ...
                    function(index, obj) {
                        ...
                        htmlStr += '<td class="t_3_q"><a "javascript:void(0)" onclick="NoticeBtn(' + obj.id + ')" title="详情">' + obj.conStr + '</a></td>';
                        htmlStr += '<td class="t_2_q">' + obj.createtime + '</td>';
                        if (type == 3) {
                            htmlStr += '<td class="t_3_q"><div class="btn_gonggao">' + '<button onclick="editSysNotice(' + obj.id + ')" type="button" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span> 修改</button>' + '<button onclick="deleteSysNotice(' + obj.id + ')" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-minus"></span> 删除</button></div></td>';
                        }
                        htmlStr += '</tr>';
                    });
