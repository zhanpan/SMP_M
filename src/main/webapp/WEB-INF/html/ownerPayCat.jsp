		...
		<div class="modal-dialog" role="document" style="width: 65%;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">添加缴费<span>必须输入姓名!</span><span>必须输入缴费金额!</span></h4>
				</div>
				<div class="modal-body-title">
					<form class="form-horizontal" role="form">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                function(index, obj) {
                    ...
                    if (type == 3) {
                        htmlStr += '<td class="t_2_q"><div class="btn_gonggao">' + '<button onclick="editOwnerPayCat(' + obj.id + ')" type="button" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span> 修改</button>' + '<button onclick="deleteOwnerPayCat(' + obj.id + ')" type="button" class="btn btn-danger"><span class="glyphicon glyphicon-minus"></span> 删除</button></div></td>';
                    }
                    htmlStr += '</tr>';
                });
    ...
    $(function() {
        ...
        $("#saveCreatePayCatBtn").click(function() {
            ...
            if (userName == '') {
                ...
                $(".modal-title").find("span:eq(1)").css("display", "none");
                return false
